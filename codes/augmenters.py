...
def random_rotation(x,
    ...
    x = apply_affine_transform(x, transform_matrix, channel_index, fill_mode, cval)
    y = apply_affine_transform(y, transform_matrix, channel_index, fill_mode, cval)
    return x, y


def augment_data(N=2):

    X_train = np.load('/Users/hasancankeles/Prostate/prostate_segmentation-master/data/train.npy')
    y_train = np.load('/Users/hasancankeles/Prostate/prostate_segmentation-master/data/train_masks.npy')
    ...
    np.save('/Users/hasancankeles/Prostate/prostate_segmentation-master/data/train_masks.npy', y_train)
