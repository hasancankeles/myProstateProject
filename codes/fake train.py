...
def load_data():
    ...
    y_train = []
    for filename in os.listdir("/Users/hasancankeles/Prostate/prostate_segmentation-master/data/train/2d"):
        if filename.endswith('.npy'):
            # Load image and label arrays
            img_array = np.load(os.path.join("/Users/hasancankeles/Prostate/prostate_segmentation-master/data/train/2d", filename))
    ...
    y_test = []
    for filename in os.listdir("/Users/hasancankeles/Prostate/prostate_segmentation-master/data/test/2d"):
        if filename.endswith('.npy'):
            # Load image and label arrays
            img_array = np.load(os.path.join("/Users/hasancankeles/Prostate/prostate_segmentation-master/data/test/2d", filename))
            # Add image and label arrays to lists
